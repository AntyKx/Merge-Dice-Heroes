...
const HERO_FRAME_SHEETS: Partial<Record<HeroId, HeroFrameSheet>> = {
  ...
  priest: { source: "/manus-storage/seven_priest_fixed_canvas_0d308aaa.png", totalFrames: 20, actions: { idle: { start: 0, count: 6 }, attack: { start: 6, count: 5 }, skill: { start: 11, count: 3 } } },
  ranger: { source: "/manus-storage/seven_ranger_fixed_canvas_cfe7e218.png", totalFrames: 20, actions: { idle: { start: 0, count: 6 }, attack: { start: 6, count: 5 }, skill: { start: 11, count: 3 } } },
  engineer: { source: "/manus-storage/seven_engineer_fixed_canvas_b10d62be.png", totalFrames: 20, actions: { idle: { start: 0, count: 6 }, attack: { start: 6, count: 5 }, skill: { start: 11, count: 3 } } },
  deathKnight: { source: "/manus-storage/seven_deathKnight_fixed_canvas_bf5c427c.png", totalFrames: 20, actions: { idle: { start: 0, count: 6 }, attack: { start: 6, count: 5 }, skill: { start: 11, count: 3 } } },
  bard: { source: "/manus-storage/seven_bard_fixed_canvas_2b7342bb.png", totalFrames: 20, actions: { idle: { start: 0, count: 6 }, attack: { start: 6, count: 5 }, skill: { start: 11, count: 3 } } },
  fighter: { source: "/manus-storage/seven_fighter_fixed_canvas_1d9c032b.png", totalFrames: 20, actions: { idle: { start: 0, count: 6 }, attack: { start: 6, count: 5 }, skill: { start: 11, count: 3 } } },
  ...
  assassin: { source: "/manus-storage/seven_assassin_fixed_canvas_f497396c.png", totalFrames: 20, actions: { idle: { start: 0, count: 6 }, attack: { start: 6, count: 5 }, skill: { start: 11, count: 3 } } },
};
...
const HERO_PORTRAITS: Partial<Record<HeroId, string>> = {
  ...
  priest: "/manus-storage/seven_leader_aligned_priest_ec8b5b79.png",
  assassin: "/manus-storage/seven_leader_aligned_assassin_ab6501ba.png",
  frostQueen: "/manus-storage/royal_princess_portrait_415f7dc6.png",
  ranger: "/manus-storage/seven_leader_aligned_ranger_335d6fab.png",
  bard: "/manus-storage/seven_leader_aligned_bard_3d55085f.png",
  deathKnight: "/manus-storage/seven_leader_aligned_deathKnight_36c8ba5d.png",
  engineer: "/manus-storage/seven_leader_aligned_engineer_5848dff2.png",
  fighter: "/manus-storage/seven_leader_aligned_fighter_d27fff9c.png",
};
